...
const CONFIG = {
  ...
  description:
    'Entreprise de charpente traditionnelle, rénovation et escaliers sur-mesure à Saulgé, Montmorillon et Poitiers (86). Expertise artisanale pour vos projets bois.',
